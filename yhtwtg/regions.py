...
def create_regions(world: WinTheGameWorld) -> None:
    ...
    starting_area.connect(teleporter_area, "Starting Area to Teleporter Area")
    starting_area.connect(castle_area_outer, "Starting Area to Castle Area Outer")
    castle_area_outer.connect(castle_area_inner, "Castle Area Outer to Castle Area Inner")
    starting_area.connect(end_game_area, "Starting Area to End Game Area")
