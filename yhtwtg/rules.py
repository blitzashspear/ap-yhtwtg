...
def set_all_rules(world: WinTheGameWorld) -> None:
    #TODO teleporter keys if applicable using add_rule.
    ...
    if world.options.split_spider_gloves:
        ...
        set_rule(world.get_location("Abandoned Alcove"), lambda state: state.has_all(("Springheel Boots", "Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Arcane Vocabulary - Top"), lambda state: state.has_all(("Springheel Boots", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Avalon Calling"), lambda state: state.has_any(("Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Danger"), lambda state: state.has_any(("Springheel Boots", "Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Don't Be Hasty - Top"), lambda state: state.has_all(("Cerulean Aura", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Hidden Crevasse"), lambda state: state.has("Springheel Boots", world.player) and state.has_any(("Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Hydra Is Myth"), lambda state: state.has_all(("Springheel Boots", "Right Spider Glove"), world.player))
        set_rule(world.get_location("KISS Principle"), lambda state: state.has_any(("Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Leap of Faith"), lambda state: state.has("Right Spider Glove", world.player))
        set_rule(world.get_location("Maps and Legends"), lambda state: state.has_all(("Springheel Boots", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Never Could See Any Other Way"), lambda state: state.has_any(("Cerulean Aura", "Springheel Boots", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Prawn Shot First"), lambda state: state.has("Crimson Aura", world.player) and state.has_any(("Springheel Boots", "Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Snake, It's a Snake"), lambda state: state.has("Right Spider Glove", world.player) or state.has_all(("Springheel Boots", "Left Spider Glove"), world.player))
        set_rule(world.get_location("Swimming Upstream"), lambda state: state.has("Right Spider Glove", world.player) or state.has_all(("Springheel Boots", "Left Spider Glove"), world.player))
        set_rule(world.get_location("Taking the Long Way - Left"), lambda state: state.has_all(("Left Spider Glove", "Right Spider Glove"), world.player) or state.has_all(("Springheel Boots", "Left Spider Glove"), world.player) or state.has_all(("Springheel Boots", "Right Spider Glove"), world.player))
        set_rule(world.get_location("Taking the Long Way - Right"), lambda state: state.has_all(("Cerulean Aura", "Crimson Aura", "Springheel Boots", "Left Spider Glove", "Right Spider Glove"), world.player))
        set_rule(world.get_location("The Arbitrarium"), lambda state: (state.has_all(("Springheel Boots", "Left Spider Glove"), world.player) or state.has("Right Spider Glove", world.player)))
        set_rule(world.get_location("Tower of Regrets"), lambda state: (state.has("Right Spider Glove", world.player) or state.has_all(("Springheel Boots", "Left Spider Glove"), world.player)) and state.has_any(("Cerulean Aura", "Springheel Boots"), world.player))
        ...
        set_rule(world.get_location("Taking the Long Way - Left"), lambda state: state.has("Spider Gloves", world.player))
